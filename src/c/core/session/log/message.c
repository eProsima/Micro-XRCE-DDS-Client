    ...
    while(read_submessage_header(&mb, &submessage_id, &length, &flags, &payload_it))
    {
        ...
        switch(submessage_id)
        {
            case SUBMESSAGE_ID_CREATE_CLIENT:
            {
                ...
                mc_deserialize_CREATE_CLIENT_Payload(&mb, &payload);
            ...
            case SUBMESSAGE_ID_CREATE:
            {
                ...
                mc_deserialize_CREATE_Payload(&mb, &payload);
            ...
            case SUBMESSAGE_ID_DELETE:
            {
                ...
                mc_deserialize_DELETE_Payload(&mb, &payload);
            ...
            case SUBMESSAGE_ID_STATUS_AGENT:
            {
                ...
                mc_deserialize_STATUS_AGENT_Payload(&mb, &payload);
            ...
            case SUBMESSAGE_ID_STATUS:
            {
                ...
                mc_deserialize_STATUS_Payload(&mb, &payload);
            ...
            case SUBMESSAGE_ID_WRITE_DATA:
            {
                ...
                mc_deserialize_WRITE_DATA_Payload_Data(&mb, &payload);
            ...
            case SUBMESSAGE_ID_READ_DATA:
            {
                ...
                mc_deserialize_READ_DATA_Payload(&mb, &payload);
            ...
            case SUBMESSAGE_ID_HEARTBEAT:
            {
                ...
                mc_deserialize_HEARTBEAT_Payload(&mb, &payload);
            ...
            case SUBMESSAGE_ID_ACKNACK:
            {
                ...
                mc_deserialize_ACKNACK_Payload(&mb, &payload);
            ...
            case SUBMESSAGE_ID_DATA:
            {
                ...
                mc_deserialize_DATA_Payload_Data(&mb, &payload);
