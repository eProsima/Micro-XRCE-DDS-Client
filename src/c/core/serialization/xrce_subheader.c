...
//                             PUBLIC
//==================================================================
void mc_serialize_submessage_header(mcMicroBuffer* mb, uint8_t id, uint8_t flags, uint16_t length)
{
...
void mc_deserialize_submessage_header(mcMicroBuffer* mb, uint8_t* id, uint8_t* flags, uint16_t* length)
{
