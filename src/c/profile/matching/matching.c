...
void hash_string(unsigned char *str, char* hash)
{
...
bool uxr_generate_hash_from_xml(const char* xml, uxrObjectId id, char* hash)
{
    bool found = true;
    ...
    switch (id.type)
    {
        ...
        case UXR_DATAWRITER_ID:
        {
            ...
            hash_string((unsigned char*) name_type_buffer, hash);
            break;
        }
...
bool uxr_generate_hash_from_ref(const char* ref, char* hash)
{
    hash_string((unsigned char*) ref, hash);
    return true;
}
