...
#ifndef _MICROXRCE_CLIENT_CORE_SESSION_OUTPUT_RELIABLE_STREAM_H_
#define _MICROXRCE_CLIENT_CORE_SESSION_OUTPUT_RELIABLE_STREAM_H_
...
#endif // _MICROXRCE_CLIENT_CORE_SESSION_OUTPUT_RELIABLE_STREAM_H_
