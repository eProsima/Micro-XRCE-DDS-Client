...
#ifndef _MICROXRCE_CLIENT_CORE_SERIALIZATION_HEADER_H_
#define _MICROXRCE_CLIENT_CORE_SERIALIZATION_HEADER_H_
...
#endif // _MICROXRCE_CLIENT_CORE_SERIALIZATION_HEADER_H_
