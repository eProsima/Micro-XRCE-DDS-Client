...
MRDLLAPI uint16_t uxr_write_create_participant_ref(mrSession* session, mrStreamId stream_id,
                                                  mrObjectId object_id, int16_t domain_id,
                                                  const char* ref, uint8_t mode);

MRDLLAPI uint16_t uxr_write_create_topic_ref(mrSession* session, mrStreamId stream_id,
                                            mrObjectId object_id, mrObjectId participant_id,
                                            const char* ref, uint8_t mode);

MRDLLAPI uint16_t uxr_write_create_datawriter_ref(mrSession* session, mrStreamId stream_id,
                                                 mrObjectId object_id, mrObjectId publisher_id,
                                                 const char* ref, uint8_t mode);

MRDLLAPI uint16_t uxr_write_create_datareader_ref(mrSession* session, mrStreamId stream_id,
