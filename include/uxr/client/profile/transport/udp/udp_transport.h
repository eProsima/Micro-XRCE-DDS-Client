...
size_t uxr_write_udp_data_platform(struct uxrUDPPlatform* platform, const uint8_t* buf, size_t len);
size_t uxr_read_udp_data_platform(struct uxrUDPPlatform* platform, uint8_t* buf, size_t len, int timeout);
