...
#define UCLIENT_BIG_ENDIANNESS_SEQ_COUNT 1
#else
#define UCLIENT_BIG_ENDIANNESS_SEQ_COUNT 0
#endif // ifdef UCLIENT_BIG_ENDIANNESS

#if  (PROFILE_SHARED_MEMORY_SEQ_COUNT + HARD_LIVELINESS_CHECK_SEQ_COUNT + UCLIENT_BIG_ENDIANNESS_SEQ_COUNT) == 0
#define UXR_PROPERTY_SEQUENCE_MAX          1
#else
#define UXR_PROPERTY_SEQUENCE_MAX          PROFILE_SHARED_MEMORY_SEQ_COUNT + HARD_LIVELINESS_CHECK_SEQ_COUNT + UCLIENT_BIG_ENDIANNESS_SEQ_COUNT
