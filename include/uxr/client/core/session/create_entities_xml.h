...
#ifndef _UXR_CLIENT_CORE_SESSION_CREATE_ENTITIES_XML_H_
#define _UXR_CLIENT_CORE_SESSION_CREATE_ENTITIES_XML_H_
...
#endif //_UXR_CLIENT_CORE_SESSION_CREATE_ENTITIES_XML_H_
