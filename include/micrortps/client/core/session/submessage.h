...
MRDLLAPI bool write_submessage_header(struct mcMicroBuffer* mb, uint8_t submessage_id, uint16_t length, uint8_t flags);
bool read_submessage_header(struct mcMicroBuffer* mb, uint8_t* submessage_id, uint16_t* length, uint8_t* flags, uint8_t** payload_it);
