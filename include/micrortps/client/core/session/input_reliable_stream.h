...
bool next_input_reliable_buffer_available(mrInputReliableStream* stream, struct mcMicroBuffer* mb);

void write_acknack(const mrInputReliableStream* stream, struct mcMicroBuffer* mb);
void read_heartbeat(mrInputReliableStream* stream, struct mcMicroBuffer* payload);
