...
#ifndef _MICRORTPS_CLIENT_SESSION_OUTPUT_BEST_EFFORT_STREAM_H_
#define _MICRORTPS_CLIENT_SESSION_OUTPUT_BEST_EFFORT_STREAM_H_
...
#endif // _MICRORTPS_CLIENT_SESSION_OUTPUT_BEST_EFFORT_STREAM_H
