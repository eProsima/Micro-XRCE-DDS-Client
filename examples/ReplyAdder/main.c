...
void on_request(uxrSession* session, uint16_t request_id, SampleIdentity* sample_id, uint8_t* request_buffer, size_t request_len, void* args)
{
    uint32_t rhs;
    uint32_t lhs;
