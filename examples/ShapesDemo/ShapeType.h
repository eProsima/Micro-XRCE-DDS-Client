...
bool mr_serialize_ShapeType_topic(struct MicroBuffer* writer, const ShapeType* topic);
bool mr_deserialize_ShapeType_topic(struct MicroBuffer* reader, ShapeType* topic);
